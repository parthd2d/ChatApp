      ...
      children: [
        ...
        GestureDetector(
          onTap: () {
            ...
            // if (showTime) {
            //   print(widget.time.toDate().toString());
            //   print(widget.time.toDate().toString().substring(11, 16));
            //   print(widget.time.toDate().toString().indexOf(':'));
            // }
          },
          child: Container(
                  ...
                  children: [
                    ...
                    if (showTime)
                      Container(
                        ...
                        child: Text(
                          widget.time.toDate().toString().substring(
                                11,
                                16,
                              ),
                        ),
